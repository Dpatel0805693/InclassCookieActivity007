          ...
          <li class="item">
            ...
            <div class="content">
              ...
              <div class="extra">
                ...
                <a class="ui icon button" href="addToFavorites.php?PaintingID=<?php echo $work['PaintingID'];?>&ImageFileName=<?php echo $work['ImageFileName'];?>&Title=<?php echo ($work['Title']);?> "><i class="heart icon"></i></a>  
              </div>        
            </div>      
          </li>
